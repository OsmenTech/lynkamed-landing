...
export function SeoJsonLd() {
  useEffect(() => {
    const organization = {
      ...
      logo: LOGO_URL,
      description:
        'Software médico en la nube para médicos y clínicas en México. Expedientes clínicos por especialidad (NOM-024), agenda, caja y portal del paciente.',
    ...
    const software = {
      ...
      image: LOGO_URL,
      description:
        'Lynkamed es el software médico en la nube para médicos y clínicas en México. Gestiona expedientes clínicos adaptados por especialidad (NOM-024), agenda médica, control de caja y portal del paciente.',
      inLanguage: 'es-MX',
      offers: [
        {
          '@type': 'Offer',
